...
COMMON_FLAGS := \
  -sv --cc --exe --vpi --build -j 12 -Wall --timing --assert -fno-dfg -f $(VERILATOR_FILELIST) $(VERILATOR_CONTROL_FILE) \
  -CFLAGS " -fno-omit-frame-pointer -std=c++20 -DVERILATOR -DTRACE -I$(REPO_ROOT)/dv/common $(COSIM_CXXINC) $(addprefix -I,$(INCDIRS))" \
  -LDFLAGS " -lpthread -lz -no-pie $(COSIM_LDFLAGS) -L$(SYSEMU_LIBDIR) -lsw-erbium -Wl,--allow-multiple-definition" # -fsanitize=address -Wl,-rpath=$(SYSEMU_LIBDIR) -lsw-sysemu -Wl,--allow-multiple-definition 
...
COMMON_FLAGS += -Wno-UNOPTFLAT -Wno-UNUSEDSIGNAL -Wno-UNUSED -Wno-UNDRIVEN -Wno-DECLFILENAME -Wno-UNUSEDPARAM \
        -Wno-UNUSEDLOOP -Wno-LATCH -Wno-CASEINCOMPLETE -Wno-CASEX -Wno-IMPLICIT -Wno-MULTIDRIVEN -Wno-SYNCASYNCNET -Wno-BLKSEQ \
        -Wno-SYMRSVDWORD -Wno-WIDTHTRUNC -Wno-WIDTHEXPAND -Wno-VARHIDDEN -Wno-PINMISSING -Wno-TIMESCALEMOD -Wno-GENUNNAMED \
        -Wno-PINCONNECTEMPTY -Wno-MODDUP -Wno-EOFNEWLINE -Wno-WIDTHCONCAT -Wno-REALCVT -Wno-ALWCOMBORDER -Wno-SIDEEFFECT \
        -Wno-INITIALDLY -Wno-DEFOVERRIDE -Wno-PROCASSWIRE -Wno-BLKANDNBLK
