...
# only force en_US.UTF-8 if it's actually installed on this system;
# otherwise fall back to C.UTF-8 (widely available, still UTF-8-aware)
# or plain C as a last resort, to avoid noisy perl/bash locale warnings.
