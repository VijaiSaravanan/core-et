...
#define NUM_SHIRE_IDS_L  LOG2(NUM_SHIRE_IDS)
...
#define CORE_NR_THREADS_L LOG2(CORE_NR_THREADS)
...
#define MAX_MINION_ID_L      LOG2(MAX_MINION_ID)
...
#define PTW_PER_N_L LOG2(PTW_PER_N)
...
#define ESR_FILTER_IPI_RESET_VAL FFFF_FFFF_FFFF_FFFF

//clock gate control
#define ESR_SHIRE_CLK_GATE_CTRL_RESET_VAL 000
...
#define NEIGH_BLOCK_PASSES_RANGE (LOG2(NEIGH_BLOCK_PASSES)-1):0 // Range to count number of passes
...
#define NEIGH_INT_FIFO_SIZE_L     LOG2(NEIGH_INT_FIFO_SIZE)
...
#define NEIGH_FILL_FIFO_RANGE (LOG2(NEIGH_FILL_FIFO_SIZE)-1):0
...
#define NEIGH_FORCE_DEST_FIFO_BANKS 0
#define NEIGH_FORCE_DEST_FIFO_UC    1
#define NEIGH_FORCE_DEST_FIFO_TBOX  2

#define NEIGH_FORCE_AGENT_BITS      2
#define NEIGH_FORCE_AGENT_DCACHE    0
#define NEIGH_FORCE_AGENT_ICACHE    1
#define NEIGH_FORCE_AGENT_TBOX      2
#define NEIGH_FORCE_AGENT_PTW       3

// Cooperative miss requests
// -------------------------
#define SHIRE_COOP_MISS_REQS   2 // TLoads to TenB and Scp
#define SHIRE_COOP_NUM_IDS     32
#define SHIRE_COOP_RDY_CREDS   3
#define SHIRE_COOP_RDY_CREDS_L LOG2(SHIRE_COOP_RDY_CREDS)
...
#define SHIRE_COOP_ID_SIZE          LOG2(SHIRE_COOP_NUM_IDS)
...
#define AD_ESR_PORT_MSG_COMMON       800
#define AD_ESR_PORT_MSG_REDUCE_READY e00
#define AD_ESR_PORT_MSG_REDUCE_DATA  e20
#define AD_ESR_PORT_MSG_TBOX_REPLY   c00
#define AD_ESR_PORT_MSG_TBOX_PULL    e40
...
#define AD_ESR_TBOX_COMM_REQ         200
#define AD_ESR_TBOX_COMM_DATA        208
...
#define AD_ESR_AGENT_TYPE_MINION     0
#define AD_ESR_AGENT_TYPE_TBOX       2
#define AD_ESR_AGENT_TYPE_SHIRE      3
...
#define AD_ESR_PROT_BITS_MSG         2
#define AD_ESR_PROT_BITS_MMODE       3
#define AD_ESR_PROT_BITS_UMODE       0
...
#define AD_SCP_FORMAT_0              0
#define AD_SCP_FORMAT_1              1
// Common L2 Format
...
#define CORE_L2_BLOCK_PASSES_RANGE     (LOG2(CORE_L2_BLOCK_PASSES)-1):0                            // Range to count number of passes
#define CORE_L2_BLOCK_ADDR_OFFSET_BITS LOG2(CORE_L2_BLOCK_SIZE/8)                                  // Addr bits that are within a block
#define CORE_L2_BLOCK_PASS_NUM_RANGE   CORE_L2_BLOCK_ADDR_OFFSET_BITS+:LOG2(CORE_L2_BLOCK_PASSES) // Bits where the pass number is from a 5:0 range
...
#define CORE_L2_BLOCK_EXT_PASSES_RANGE     (LOG2(CORE_L2_BLOCK_EXT_PASSES)-1):0                                // Range to count number of passes
#define CORE_L2_BLOCK_EXT_ADDR_OFFSET_BITS LOG2(CORE_L2_BLOCK_EXT_SIZE/8)                                      // Addr bits that are within a block
#define CORE_L2_BLOCK_EXT_PASS_NUM_RANGE   CORE_L2_BLOCK_EXT_ADDR_OFFSET_BITS+:LOG2(CORE_L2_BLOCK_EXT_PASSES) // Bits where the pass number is from a 5:0 range
...
#define MTIME_TICK_CNT_R (LOG2(MTIME_TICK_PRESCALER)-1):0

#define FCC_PER_MIN   2
#define FCC_PER_MIN_R (LOG2(FCC_PER_MIN)-1):0
